      ...
      <div className="container px-4 md:px-6">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
          <div className="flex flex-col justify-center space-y-8">
            <div className="space-y-4">
              ...
              <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none bg-clip-text text-transparent bg-gradient-to-r from-white to-white/70">
                ...
                <span className="text-blue-400">Straight to Your Door</span>
              </h1>
          ...
          <div className="mx-auto lg:ml-auto flex items-center justify-center">
              ...
              <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-blue-500/30 to-blue-600/30 blur-3xl animate-pulse"></div>
              <div className="relative h-full w-full rounded-2xl border border-slate-700 bg-slate-800/50 backdrop-blur-sm p-6 shadow-2xl flex flex-col items-center justify-center overflow-hidden">
                ...
                <div className="z-20 text-center space-y-6">
                  <div className="relative mx-auto h-32 w-32 rounded-full bg-blue-500/20 flex items-center justify-center">
                    <Flame className="h-20 w-20 text-blue-400 animate-bounce duration-[3000ms]" />
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="text-4xl font-bold text-blue-400">₦1,000<span className="text-lg text-slate-400 font-normal">/kg</span></div>
                  ...
                  <div className="grid grid-cols-2 gap-4 w-full max-w-xs mx-auto pt-4">
                    <div className="rounded-lg bg-slate-900/50 p-3 border border-slate-700">
                      <div className="text-xs text-slate-400">12.5kg</div>
                      <div className="font-bold">₦12,500</div>
                    </div>
                    <div className="rounded-lg bg-slate-900/50 p-3 border border-slate-700">
                      <div className="text-xs text-slate-400">6kg</div>
